<?php
/**
 * Template Name: treatments single Template
 */
...
// List of Why choose me
$visibility_list_of_why_choose_me = get_field( 'visibility_list_of_why_choose_me' );
...
// Content two row with signature
$visibility_content_two_row_with_signature = get_field( 'visibility_content_two_row_with_signature' );

// Content First Treatments Content
$visibility_content_firstt_treatments_content = get_field( 'visibility_content_firstt_treatments_content' );

// Content Table Single Treatments
$visibility_content_table_single_treatments = get_field( 'visibility_content_table_single_treatments' );
...
<div class="wrapper" id="hope--page__wrapper">
    ...
    <?php if ($visibility_content_two_row_with_signature) { 
    ?>
        <section class="fmm__section--third">
            <div class="container container--content">
                <?php the_field( 'title_content_two_row_with_signature' ); ?>
                <div class="row">

                    <div class="col-lg-6">
                        <?php the_field( 'content_two_row_with_signature_left' ); ?>
                    </div>

                    <div class="col-lg-6">
                        <?php the_field( 'content_two_row_with_signature_right' ); ?>
    ...
    <?php if ($visibility_content_table_single_treatments) { 
    ?>
        <section class="fmm__section--treatments">
            <div class="container container--treatments">
            <?php the_field( 'content_header_content_table_single_treatments' ); ?>
            <div class="table">
                <div class="table-holder">
                    <div class="table-row tl">
                        <p class="td"><?php the_field( 'left_table_title' ); ?></p>
                        <?php if ( have_rows( 'left_table_repeater' ) ) : ?>
                            <?php while ( have_rows( 'left_table_repeater' ) ) : the_row(); ?>
                                <p class="td"><?php the_sub_field( 'single_left_title' ); ?></p>
                            <?php endwhile; ?>
                        <?php else : ?>
                            <?php // no rows found ?>
                        <?php endif; ?>
                    ...
                    <div class="table-row tr">
                        <p class="td"><?php the_field( 'right_table_title' ); ?></p>
                        <?php if ( have_rows( 'right_table_repeater' ) ) : ?>
                            <?php while ( have_rows( 'right_table_repeater' ) ) : the_row(); ?>
            ...
            <?php the_field( 'content_footer_content_table_single_treatments' ); ?>
            </div>
        </section>
    <?php
    } else { 
    ...
    ?>
        <section class="fmm__section--fifth treatments">
            <div class="container container--content">
    ...
    <?php if ($visibility_list_of_why_choose_me) { 
    ?>
        <section class="fmm__section--ninth">
            <div class="container container--content">
            <?php the_field( 'content_list_of_why_choose_me' ); ?>
                <div class="row">
                    <?php if ( have_rows( 'list_of_why_choose_me' ) ) : ?>
                        <?php while ( have_rows( 'list_of_why_choose_me' ) ) : the_row(); ?>
                            <div class="col-md-6 home--card">
                                <div class="header-img-title">
                                    <div class="img">
                                    <?php $icon_list_of_why_choose_me = get_sub_field( 'icon_list_of_why_choose_me' ); ?>
                                    <?php if ( $icon_list_of_why_choose_me ) { ?>
                                        <?php echo wp_get_attachment_image( $icon_list_of_why_choose_me, 'thumbnail' ); ?>
                                    <?php } ?>
                                    </div>
                                    <h5><?php the_sub_field( 'title_list_of_why_choose_me' ); ?></h5>
                                </div>
                                <?php the_sub_field( 'content_list_of_why_choose_me' ); ?>
                            </div>
                        <?php endwhile; ?>
                    <?php else : ?>
                        <?php // no rows found ?>
    ...
    <?php if ($visibility_content_firstt_treatments_content) { 
    ?>
        <section class="fmm__section--thirteenth">
            <div class="container container--content">
                <?php the_field( 'content_content_firstt_treatments_content' ); ?>
            </div>
        </section>
    <?php
    } else { 
