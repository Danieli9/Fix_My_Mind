...
<div class="wrapper" id="hope--page__wrapper">
    ...
    <section class="home__section--third">
        <div class="container container--content">
            ...
            <div class="content--footer">
                <div class="signature">
                    ...
                    <div class="blue--box">
                        <p><b>James Mallinson</b><br> Co-Founder Fix My Mind</p>
                    </div>
                </div>
                <div class="image">
    ...
    <section class="home__section--contact">
        <div class="container">
    ...
    <section class="home__section--fifth">
        <div class="container container--content">
    ...
    <section class="home__section--sixth">
    ...
    <section class="home__section--seventh">
    ...
    <section class="home__section--eighth">
        <div class="container">
            <h2>What can Hypnotherapy <br><span>help you</span> with</h2>
            <div class="container--content">
                <p>With Clinical Hypnotherapy it’s totally possible to work with anxiety, panic attacks, stop smoking, losing weight and more.  People often come to us – and achieve successful and lasting results – when other therapists have failed*.</p>
                <p>These are just some of the treatments we offer you:</p>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 home--card">
                    <div class="card-header">
                        <img src="http://fixmymind.test/wp-content/uploads/2022/09/brain.svg" alt="test">
                        <h4>The Anxiety Fix</h4>
                    </div>
                    <div class="text-holder">
                        <p>Hypnotherapy can help you overcome anxiety. Whether it’s anxiety surrounding a particular issue – e.g. public speaking or socialising – or more generalised anxiety.</p>
                        <p>Ordinarily just one to two sessions can help clients deal with the debilitating impact of anxiety. And it’s all natural and drug-free. We are able to deal with issues such as negative internal self-talk and provide a host of skills to help you achieve positive outcomes*.</p>
            ...
            <div class="container--content-footer">
                <p>Our hypnotherapists can help you with a wide range of problems. These are just a selection of our treatments – please click the button below to see the full list.</p>
                <p>Or, give us a call on 0800 122 3073 to discuss your specific problem.</p>
                <a href="#" class="btn">See all our treatments</a>
            </div>
        </div>
    </section>

    <section class="home__section--ninth">
        <div class="container container--content">
    ...
    <section class="home__section--twelfth">
    ...
    <section class="home__section--thirteenth">
        <div class="container container--content">
            <h2 class="h1"><span>How to book</span> your hypnotherapy <br> session for anxiety</h2>
            <p>Hopefully you now feel ready to take the next step to being calmer. Most clients need only a couple of sessions to be better.</p>
            <p>Each session will be 90 minutes long.  This means we achieve so much more than you can in the traditional 50-minute therapy hour that most therapists provide.  As part of my ‘Covid recovery’ promotion, I’m reducing that by 10% to only £290 + VAT per session.  Genuinely, I have very limited availability and if you’d like to know more about how I may be able to help you, then do get in touch now.</p>
            <p>I will put 100% effort in working with you and the techniques that used are very powerful. Success, as with all therapy types varies from client to client and there can be no guarantee of success. In fact, we’d recommend running a mile from people providing guarantees.</p>
            <p>Please note that I only have limited availability in any given month. If you’d like to know how I might be able to help you, everything begins with my free 20-minute consultation. If you’d like to start your own journey towards a calmer you, then just call freephone 0800 122 3073 or fill out the form below. You’ll also get your free one-hour download to help you relax.</p>
            <p>Here’s to you being calmer!</p>
        </div>
    </section>
