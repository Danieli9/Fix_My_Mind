<?php
/**
 * Template Name: therapies single Template
 */
...
// Extended Therapies Content
$visibility_extended_therapies_content = get_field( 'visibility_extended_therapies_content' );
...
<div class="wrapper" id="hope--page__wrapper">
    ...
    <?php if ($visibility_extended_therapies_content) { 
    ?>
        <section class="fmm__section--thirteenth">
            <div class="container container--content">
                <?php the_field( 'content_extended_therapies_content' ); ?>
            </div>
        </section>
    <?php
    } else { 
